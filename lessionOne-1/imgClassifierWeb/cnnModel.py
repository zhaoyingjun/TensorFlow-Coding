...
class cnnModel(object):
    def __init__(self,percent,learning_rate,learning_rate_decay_factor,forward_only=False):
       ...
       # self.forward_only=forward_only
        ...
        def fc_layer(flattened_layer, num_inputs, num_outputs):
            ...
            return fc_resultl
        self.data_tensor=tf.placeholder(tf.float32,shape=[500,gConfig['im_dim'], gConfig['im_dim'],gConfig['num_channels']],name='data_tensor')
        self.label_tensor=tf.placeholder(tf.int32,shape=[500],name='label_tensor')
        ...
        ops = tf.train.GradientDescentOptimizer(self.learning_rate)
        ...
        if not forward_only:
            ...
            self.updates.append(ops.apply_gradients(
